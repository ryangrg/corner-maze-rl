...
# Lookup keys: pose_label, pose_to_idx, label_names, embeddings (float32),
# left_eyes/right_eyes (uint8, /255 to recover [0,1] float).
POSE_VISUAL_NPZ_PATH = 'data/lookups/pose_visual.npz'
EMBEDDING_DIM = 60
EYE_IMG_SIZE = 128  # 128x128 grayscale images

# View observation mode: precomputed (21, 21, 3) uint8 egocentric views,
# one row per pose_label, generated by scripts/build_minigrid_view_lookup.py
MINIGRID_VIEWS_NPZ_PATH = 'data/lookups/minigrid_views.npz'
